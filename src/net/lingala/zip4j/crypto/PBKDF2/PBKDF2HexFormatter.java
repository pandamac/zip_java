...
class PBKDF2HexFormatter
{
    public boolean fromString(net.lingala.zip4j.crypto.PBKDF2.PBKDF2Parameters p, String s)
    {
        ...
        byte salt[] = net.lingala.zip4j.crypto.PBKDF2.BinTools.hex2bin(p123[0]);
        int iterationCount = Integer.parseInt(p123[1]);
        byte bDK[] = net.lingala.zip4j.crypto.PBKDF2.BinTools.hex2bin(p123[2]);
    ...
    {
        String s = net.lingala.zip4j.crypto.PBKDF2.BinTools.bin2hex(p.getSalt()) + ":"
